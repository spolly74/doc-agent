...
from doc_agent.models.evaluation import BatchEvaluationResult, EvaluationResult

logger = logging.getLogger("doc_agent.output.markdown")
    ...
    def __init__(
        ...
        try:
            self._env = Environment(
                loader=PackageLoader("doc_agent.output", "templates"),
