...
def setup_logging(
    ...
    # Create logger
    logger = logging.getLogger("foundry_eval")
...
def get_logger(name: str = "foundry_eval") -> logging.Logger:
    """Get a logger instance.

    Args:
        name: Logger name (will be prefixed with "foundry_eval.").

    Returns:
        Logger instance.
    """
    if not name.startswith("foundry_eval"):
        name = f"foundry_eval.{name}"
